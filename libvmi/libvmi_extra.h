...
/*
 * KDBG signatures used to fingerprint Windows
 */
typedef enum {
    VMI_WINDOWS_2000_SIGNATURE  = 0x0208U,
    VMI_WINDOWS_XP_SIGNATURE    = 0x0290U,
    VMI_WINDOWS_2003_SIGNATURE  = 0x0318U,
    VMI_WINDOWS_VISTA_SIGNATURE = 0x0328U,
    VMI_WINDOWS_2008_SIGNATURE  = 0x0330U,
    VMI_WINDOWS_7_SIGNATURE     = 0x0340U,
    VMI_WINDOWS_8_SIGNATURE     = 0x0360U
} kdbg_signature_t;
